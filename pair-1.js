                        ...
                        const menuMessage = {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    buttonText: { displayText: '⚱️ ʙᴏᴛ ɪɴғᴏ' },
                                    type: 1
                                }
                            ],
                            headerType: 1,
                ...
                case 'fc': {
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363402708281380@newsletter'
                        });
                    }
...
`;
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnail || 'https://i.ibb.co/MxFWBRq8/55a2a076a051.jpg' }, // Fallback image
                            caption
                        }, { quoted: fakevCard });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '🌌 PROBLÈMATIQUE MINI BOT NASA NEWS',
                ...
                case 'cricket': {
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: formatMessage(
                                '🌹 MINI PROBLÈMATIQUE MD CRICKETS NEWS🌹',
                                `📢 *${title}*\n\n` +
                                `🏆 *ᴍᴀʀᴋ*: ${score}\n` +
                                `🎯 *ᴛᴏ ᴡɪɴ*: ${to_win}\n` +
                                `📈 *ᴄᴜʀʀᴇɴᴛ Rate*: ${crr}\n\n` +
                ...
                case 'winfo': {
                    ...
                    try {
                        ...
                        if (statusData?.status) {
                            winfoBio = `${statusData.status}\n└─ 📌 ᴜᴘᴅᴀᴛᴇᴅ: ${statusData.setAt ? new Date(statusData.setAt).toLocaleString('en-US', { timeZone: 'Africa/Guinée' }) : 'Unknown'}`;
                        }
                    } catch (e) {
                    ...
                    try {
                        ...
                        if (lastSeenData?.lastSeen) {
                            winfoLastSeen = `🕒 ${new Date(lastSeenData.lastSeen).toLocaleString('en-US', { timeZone: 'Africa/Guinée' })}`;
                        }
                    } catch (e) {
                ...
                case 'ai': {
                    ...
                    const prompt = `ʏᴏᴜʀ name is MINI PROBLÈMATIQUE MD. 
...
User Message: ${q}
    `;
                ...
                case 'aiimg': {
                    ...
                    if (!prompt) {
                        return await socket.sendMessage(sender, {
                            text: '🎨 *Give me a spicy prompt to create your AI image,*'
                        });
                    }
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: imageBuffer,
                            caption: `🧠 *PROBLÈMATIQUE MINI BOT AI IMAGE*\n\n📌 ᴘʀᴏᴍᴘᴛ: ${prompt}`
                        }, { quoted: fakevCard });
                    } catch (err) {
                ...
                case 'gossip': {
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 *MINI PROBLÈMATIQUE MD* ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
                ...
                case 'add': {
                    ...
                    if (args.length === 0) {
                        await socket.sendMessage(sender, {
                            text: `📌 *ᴜsᴀɢᴇ:* ${config.PREFIX}add +224xxxxx\n\nExample: ${config.PREFIX}add +224xxxxx`
                        }, { quoted: fakevCard });
                        break;
                    }
                    try {
                ...
                case 'kick': {
                    ...
                    if (args.length === 0 && !msg.quoted) {
                        await socket.sendMessage(sender, {
                            text: `📌 *ᴜsᴀɢᴇ:* ${config.PREFIX}ᴋɪᴄᴋ +224xxxxx ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ ᴡɪᴛʜ ${config.PREFIX}ᴋɪᴄᴋ`
                        }, { quoted: fakevCard });
                        break;
                    }
                    try {
                ...
                case 'promote': {
                    ...
                    if (args.length === 0 && !msg.quoted) {
                        await socket.sendMessage(sender, {
                            text: `📌 *ᴜsᴀɢᴇ:* ${config.PREFIX}ᴘʀᴏᴍᴏᴛᴇ +224xxxxx ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ ᴡɪᴛʜ ${config.PREFIX}promote`
                        }, { quoted: fakevCard });
                        break;
                    }
                    try {
                ...
                case 'demote': {
                    ...
                    if (args.length === 0 && !msg.quoted) {
                        await socket.sendMessage(sender, {
                            text: `📌 *ᴜsᴀɢᴇ:* ${config.PREFIX}ᴅᴇᴍᴏᴛᴇ +224xxxx ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ ᴡɪᴛʜ ${config.PREFIX}ᴅᴇᴍᴏᴛᴇ`
                        }, { quoted: fakevCard });
                        break;
                    }
                    try {
                ...
                case 'unmute': {
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: 'https://i.ibb.co/MxFWBRq8/55a2a076a051.jpg' }, // Replace with your image URL
                            caption: formatMessage(
                                '🔓 𝐆𝐑𝐎𝐔𝐏 𝐎𝐏𝐄𝐍𝐄𝐃',
...
🔽 *ᴘʀᴇssᴜʀᴇ:* ${data.main.pressure} hPa
    `;
                ...
                case 'script': {
                    try {
                        await socket.sendMessage(sender, { react: { text: '🪄', key: msg.key } });
                        const githubRepoURL = 'https://github.com/ib960965-cloud/MINI-INCONNU-XD';
...
`;
                        ...
                        const repoMessage = {
                            ...
                            contextInfo: {
                                ...
                                isForwarded: true,
                                forwardedNewsletterMessageInfo: {
                                    newsletterJid: config.NEWSLETTER_JID || '120363402708281380@newsletter',
                                    newsletterName: 'MINI PROBLÈMATIQUE MD',
                                    serverMessageId: 143
                                }
                            }
                ...
                case 'repo-visit': {
                    await socket.sendMessage(sender, { react: { text: '🌐', key: msg.key } });
                    await socket.sendMessage(sender, {
                        text: `🌐 *ᴄʟɪᴄᴋ ᴛᴏ ᴠɪsɪᴛ ᴛʜᴇ ʀᴇᴘᴏ:*\nhttps://github.com/ib960965-cloud/MINI-INCONNU-XD`,
                        contextInfo: {
                            externalAdReply: {
                                title: 'Visit Repository',
                                body: 'Open in browser',
                                mediaType: 1,
                                mediaUrl: 'https://github.com/ib960965-cloud/MINI-INCONNU-XD',
                                sourceUrl: 'https://github.com/ib960965-cloud/MINI-INCONNU-XD'
                            }
                        }
                    }, { quoted: fakevCard });
                    break;
